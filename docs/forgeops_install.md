...
```
  ...
  -t, --tag string                     Tag/version to install
...
* [forgeops install quickstart](forgeops_install_quickstart.md)	 - Installs the ForgeRock Cloud Deployment Quickstart (CDQ)
* [forgeops install sa](forgeops_install_sa.md)	 - Installs the ForgeRock secret-agent
